...
import static com.junjunguo.pocketmaps.fragments.MyAddressAdapter.log;
        ...
        new AsyncTask<Void, Void, GHResponse>() {
            ...
            protected GHResponse doInBackground(Void... v) {
              ...
              if (Variable.getVariable().isShowingSpeedLimits() || Variable.getVariable().isSpeakingSpeedLimits())
              {
                  ...
                  req.getPathDetails().add(Parameters.Details.AVERAGE_SPEED);
              }
            ...
            protected void onPostExecute(GHResponse ghResp) {
                if (!ghResp.hasErrors()) {
                    ...
                    builder.setTitle("Your destination have to Reach " + (int) (resp.getDistance() / 100) / 10f
                                    + "km long, time:" + resp.getTime() / 60000f + "min.")
